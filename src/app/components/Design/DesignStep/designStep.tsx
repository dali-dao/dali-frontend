      ...
      <Grid item xs={2} container>
        <Grid item>
          <Grid className={selectedStepItem[0] ? classes.stepSelect : classes.step} onClick={selectItemFn0} container>
            ...
            >
              {' '}
              {selectedStepItem[0] ? 1 : confirmStepItem[0] ? <DoneIcon /> : 1}{' '}
            </Grid>
            <Grid>
              <img
                src={
                  selectedStepItem[0]
                    ? localStorage.getItem('appTheme') === 'lightTheme'
                      ? Appearance
                      : AppearanceBlack
                    : localStorage.getItem('appTheme') === 'lightTheme'
                    ? AppearanceBlack
            ...
            <Grid className={classes.itemTitle} item xs={12}>
              APPEARANCE
            </Grid>
      ...
      <Grid item xs={2} container>
        <Grid item>
          <Grid className={selectedStepItem[1] ? classes.stepSelect : classes.step} onClick={selectItemFn1} container>
            ...
            >
              {' '}
              {selectedStepItem[1] ? 2 : confirmStepItem[1] ? <DoneIcon /> : 2}{' '}
            </Grid>
            <Grid>
              <img
                src={
      ...
      <Grid item xs={2} container>
        <Grid item>
          <Grid className={selectedStepItem[2] ? classes.stepSelect : classes.step} onClick={selectItemFn2} container>
            ...
            >
              {' '}
              {selectedStepItem[2] ? 3 : confirmStepItem[2] ? <DoneIcon /> : 3}{' '}
            </Grid>
            <Grid>
              <img
                src={
      ...
      <Grid item xs={2} container>
        <Grid item>
          <Grid className={selectedStepItem[3] ? classes.stepSelect : classes.step} onClick={selectItemFn3} container>
            ...
            >
              {' '}
              {selectedStepItem[3] ? 4 : confirmStepItem[3] ? <DoneIcon /> : 4}{' '}
            </Grid>
            <Grid>
              <img
                src={
      ...
      <Grid item xs={2} container>
        <Grid item>
          <Grid className={selectedStepItem[4] ? classes.stepSelect : classes.step} onClick={selectItemFn4} container>
            ...
            >
              {' '}
              {selectedStepItem[4] ? 5 : confirmStepItem[4] ? <DoneIcon /> : 5}{' '}
            </Grid>
            <Grid>
              <img
                src={
      ...
      <Grid item xs={2} container>
        <Grid item>
          <Grid className={selectedStepItem[5] ? classes.stepSelect : classes.step} onClick={selectItemFn5} container>
            ...
            >
              {' '}
              {selectedStepItem[5] ? 6 : confirmStepItem[5] ? <DoneIcon /> : 6}{' '}
            </Grid>
            <Grid>
              <img
                src={
