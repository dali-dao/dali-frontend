...
const useStyles = makeStyles((theme: Theme) => ({
  ...
  wallet_name: {marginLeft: 10, marginTop: 10, fontFamily: 'CerebriSansPro-ExtraBold'},
  des_font_color: {color: '#919398', textAlign: 'left'},
  refreshPage:{color: '#eed332', marginLeft: 5},
  back_button: {color: '#fff', border: '1px solid #596275', borderRadius: 5, marginRight: 20, width: 145, height: 50},
