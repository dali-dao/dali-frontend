    ...
    <div className={classes.root}>
      ...
      <Grid container className={classes.wallet_image_content}>
        ...
        <Grid item xs={12} sm={6} md={3} className={classes.wallets}>
          <img className={classes.verticalAlignMiddle} alt='Trezor' src={ localStorage.getItem('appTheme') === 'lightTheme' ? TrezorBlack : Trezor}></img><span  className={classes.marginLeft10}>Trezor</span>
        </Grid>
        <Grid item xs={12} sm={6} md={3} className={classes.wallets}>
        ...
        <Grid item xs={12} sm={6} md={3} className={classes.wallets}>
          <img alt='Ledgez' src={ localStorage.getItem('appTheme') === 'lightTheme' ? LedgezBlack : Ledgez} className={classes.verticalAlignMiddle}></img><span  className={classes.marginLeft10}>Ledgez</span>
        </Grid>
        <Grid item xs={12} sm={6} md={3} className={classes.wallets}>
        ...
        <Grid item xs={12} sm={6} md={3} className={classes.wallets}>
          <img alt='GnezisSafe' src={ localStorage.getItem('appTheme') === 'lightTheme' ? GnezisSafeBlack : GnezisSafe} className={classes.verticalAlignMiddle}></img><span  className={classes.marginLeft10}>Gnezis safe</span>
        </Grid>
        <Grid item xs={12} sm={6} md={3} className={classes.wallets}>
