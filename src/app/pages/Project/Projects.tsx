...
function Projects() {
  ...
  const projectItem = new Array(1).fill({
    ...
    price: 77789,
    date: '01-01-21',
    desc: 'SharkDAO owns Nouns #2,#5,#33',
  })
            ...
            <Grid item>
              ...
              <p className={classes.project_banner_description}>
                <span className={classes.font13}>
                  ...
                  endorsed or vetted by JuiceboxDAO, so you should do your own research and understand the risks before
          ...
          <Grid item xs={12} md={4}>
            <Grid container className={classes.create_button_content} justifyContent="flex-end">
              <Grid item className={classes.project_banner_button_content}>
                <Link to="/design" className={classes.create_project_button}>
                  CREATE PROJECT
                </Link>
              </Grid>
            </Grid>
      ...
      <Grid className={classes.list_content}>
        <Grid className={classes.project_content}>
          <Grid className={classes.project_list_container}>
            ...
            <div>
              <Pagination
                className={classes.pagination_content}
                color="secondary"
                count={10}
                variant="outlined"
                shape="rounded"
