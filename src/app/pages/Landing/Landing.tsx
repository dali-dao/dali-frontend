      ...
      <div className={classes.root}>
        <Grid className={classes.section1} container>
          ...
          <Grid className={classes.bannerDesc} item xs={5}>
            <Grid className={classes.descTitle}>Community funding for people and projects</Grid>
            <Grid className={classes.bannerDescription}>
              Build a community around a project, fund it, and program its spending. Light enough for a group of
              friends, powerful enough for a global network of anons.
            </Grid>
        ...
        <Grid className={classes.section4}>
          ...
          <Grid className={classes.section4Text}>
            ...
            <br /> VULNERABLE TO BUGS OR EXPLOITS. BE SMART!
            <Link to="/design" style={{ textDecoration: 'none' }}>
        ...
        <Grid className={classes.section5}>
          <Grid className={classes.faq}>frequently asked questions</Grid>
          <Grid container>
